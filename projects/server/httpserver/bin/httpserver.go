...
import (
	"flag"
	"fmt"
	"github.com/bright1208/opera/httpserver"
...
func main() {
	...
	var port = flag.Int("post", 4000, "port")
	var imgDomain = flag.String("imgdomain", "https://img.operawarrior.com", "conf path")
	...
	// 初始化log
	logPathFile := path.Join(*logPath, "httpserver.log")
