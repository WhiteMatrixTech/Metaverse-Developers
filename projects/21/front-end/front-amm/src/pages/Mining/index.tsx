...
import { Button, CardBody, Text, IconButton } from '@titanswap-libs/uikit'
...
export default function Mining() {
  return (
    <>
      <MiningTitle>ROM 矿池</MiningTitle>
      <MainTop>
        <MainTopItem>
          <RowBetween style={{width: '50%'}}>
            {/* variant="text" onClick={onPresentSettings} title="Settings" */}
