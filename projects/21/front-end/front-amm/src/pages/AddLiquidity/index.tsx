...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from '@titanswap-libs/sdk'
import { Button, CardBody, AddIcon, Text as UIKitText } from '@titanswap-libs/uikit'
          ...
          <TransactionConfirmationModal
            ...
            content={() => (
              <ConfirmationModalContent
                title={noLiquidity ? t('swap98') : t('swap122')}
                onDismiss={handleDismissConfirmation}
              ...
              {currencies[Field.CURRENCY_A] && currencies[Field.CURRENCY_B] && pairState !== PairState.INVALID && (
                <div>
                  <UIKitText
                    ...
                    mb="2px"
                  >
                    {noLiquidity ? t('swap100') : t('swap101')}
                  </UIKitText>
                  <Pane>
                    <PoolPriceBar
                      currencies={currencies}
                    ...
                    isValid && (
                      <RowBetween>
                        {approvalA !== ApprovalState.APPROVED && (
                          ...
                          >
                            {approvalA === ApprovalState.PENDING ? (
                              <Dots>{t('swap87')} {currencies[Field.CURRENCY_A]?.symbol}</Dots>
                            ) : (
                              `${t('swap39')} ${currencies[Field.CURRENCY_A]?.symbol}`
                            )}
                          </Button>
                        )}
                        {approvalB !== ApprovalState.APPROVED && (
                          ...
                          >
                            {approvalB === ApprovalState.PENDING ? (
                              <Dots>{t('swap87')} {currencies[Field.CURRENCY_B]?.symbol}</Dots>
                            ) : (
                              `${t('swap39')} ${currencies[Field.CURRENCY_B]?.symbol}`
                            )}
                          </Button>
                        )}
                      </RowBetween>
