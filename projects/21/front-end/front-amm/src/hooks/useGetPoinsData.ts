    ...
    const fetchData = async () => {
      try {
        if(poinsContract && account){
          const [signInDate, signInContinuous, swapDate, swapQuantity, swapContinuous, liquidityDate, liquidityWeekDay, liquidityQuantity, totalPoints, isUsed] = await poinsContract.userList(account);
