...
import { Heading, IconButton, Text, Flex, useModal } from '@titanswap-libs/uikit'
  ...
  return (
    <StyledPageHeader>
      <Flex alignItems="center">
        ...
        <IconButton variant="text" onClick={onPresentSettings} title={t('swap8')}>
          <CogIcon />
        </IconButton>
        <IconButton variant="text" onClick={onPresentRecentTransactions} title={t('swap13')}>
          <HistoryIcon />
        </IconButton>
      </Flex>
