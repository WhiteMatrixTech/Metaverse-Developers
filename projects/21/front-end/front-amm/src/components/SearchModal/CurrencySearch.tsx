import { Currency, ETHER, Token } from '@titanswap-libs/sdk'
import React, { KeyboardEvent, RefObject, useCallback, useContext, useEffect, useMemo, useRef, useState } from 'react'
import { Text, CloseIcon } from '@titanswap-libs/uikit'
  ...
  return (
    <Column style={{ width: '100%', flex: '1 1' }}>
      <PaddedColumn gap="14px">
        <RowBetween>
          <Text>
            <TranslatedText translationId={82}>{t('swap23')}</TranslatedText>
            <QuestionHelper
        ...
        <RowBetween>
          <Text fontSize="14px">
            <TranslatedText translationId={126}>{t('swap26')}</TranslatedText>
          </Text>
