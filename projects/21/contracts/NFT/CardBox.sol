...
contract CardBox is ERC721, ERC721Burnable, ERC721Holder, Ownable {
    ...
    function mint(address to, string memory tokenURI) external onlyMarket returns (uint256){
        _tokenIds.increment();
    ...
    function isMarket(address _mAddr) public view returns (bool){
    ...
    modifier onlyMarket(){
        require(isMarket(msg.sender), "only market");
        _;
    }
}
